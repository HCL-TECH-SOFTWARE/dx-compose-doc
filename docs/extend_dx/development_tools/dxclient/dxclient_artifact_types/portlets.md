...
-   **Portlet Application web archive file**
    ...
    This web archive .war file should contain the necessary portlet artifacts for deployment, as per the JSR 286 portlet standard. Refer to [Importing WAR files](../../../../deploy_dx/manage//portal_admin_tools/xml_config_interface/xml_config_ref/adxmlref_import_war.md).
