...
!!! note
    Refer to [JavaServer Faces implementation](../../../../deploy_dx/manage/migrate/next_steps/post_mig_activities/addon_integration_task/mig_post_jsf.md) for information about HCL DX JSF Bridge.
