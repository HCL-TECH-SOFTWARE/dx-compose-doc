...
-   **[Securing the WSRP Consumer by HTTP-cookie-based single sign-on](wsrpt_cons_sec_ws_http_cb_sso.md)**  
...
-   **[Configuring WSRP Producer ports for Web Service Security on the Consumer portal](wsrpt_cons_sec_ws_wss.md)**  
...
-   **[Configuring WSRP web service clients](../cfg_security_consumer_portal/cfg_wsrp_webservice_clients/wsrpt_cons_cfg_wsrvc_clnt.md)**  
...
-   **[Enabling Portal Access Control for a WSRP Consumer portal](wsrpt_cons_sec_pac.md)**  
