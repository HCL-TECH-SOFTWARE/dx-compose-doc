...
2.  Enable and configure single sign-on for HTTP requests with SPNEGO following the steps in this [Enabling and configuring single sign-on for HTTP requests using SPNEGO](../../../../../../../deploy_dx/manage/security/people/authentication/external_sec_mgmt/enable_spnego/index.md).

3.  Configure eTrust SiteMinder following the steps in the article [Configuring eTrust SiteMinder](../../../../../../../deploy_dx/manage/security/people/authentication/external_sec_mgmt/etrust_siteminder/index.md).
