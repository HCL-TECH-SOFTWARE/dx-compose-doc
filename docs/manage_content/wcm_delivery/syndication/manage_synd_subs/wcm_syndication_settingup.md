...
7.  Enter the syndicator URL in the form of `http://HostName:HostPort/WcmContextRoot`.
    ...
    !!! note
        For syndication to work in HTTPs, you have to import the SSL certificates between syndicator and subscriber servers. Refer to [Syndicate the source and target environments](../../../../deploy_dx/manage/container_configuration/container_staging.md#syndicate-the-source-and-target-environments) for more information.
