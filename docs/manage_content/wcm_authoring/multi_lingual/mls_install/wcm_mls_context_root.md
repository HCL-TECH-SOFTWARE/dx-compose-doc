...
1.  Ensure that the WebSphere®Portal context root is modified as described in [Changing the portal URI after an installation](../../../../deploy_dx/manage/siteurl_cfg/changing_portal_uri_after_install/index.md).
