...
The following table describes the possible entitlement-check response scenarios and the corresponding behavior of the HCL Digital Experience Compose 9.5 Tiers 1 - 3 services.
