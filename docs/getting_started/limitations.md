...
- Supported databases include Derby, DB2 and Oracle. Amazon RDS currently supports Oracle versions 19c and 21c (for both single-tenant & multi-tenant configurations). It also supports SQL Server version 2022.
