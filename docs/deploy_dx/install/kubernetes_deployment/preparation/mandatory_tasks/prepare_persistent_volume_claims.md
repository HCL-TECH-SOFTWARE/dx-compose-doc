...
Before you proceed, review the [Persistent Volumes and related operations considerations](https://help.hcl-software.com/digital-experience/9.5/latest/get_started/plan_deployment/container_deployment/persistent_volumes/){target="blank"} topic in the DX Help Center.
...
<!--
    Information regarding how to calculate the number of required volumes for the DX WebEngine and Persistence applications is presented in the [Persistent Volumes and related operations considerations](../../../../../../get_started/plan_deployment/container_deployment/persistent_volumes.md) topic in the DX Help Center.
