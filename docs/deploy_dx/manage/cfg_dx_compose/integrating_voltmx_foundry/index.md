...
In WebEngine, you can add the list-rendering profile by navigating to the following path:
...
Save the changes and restart the server to apply the new list-rendering profile.
