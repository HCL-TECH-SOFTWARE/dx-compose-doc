...
The name of the customization in the example (`authOverride`) can be any string. However, it is recommended that you use a name that describes the change it applies.
