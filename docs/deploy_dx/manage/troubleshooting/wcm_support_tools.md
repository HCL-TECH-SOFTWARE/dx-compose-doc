...
Refer to the following topic for additional information: [Switching from HCL Digital Experience 9.5 Practitioner Studio to the HCL Digital Experience 8.5 and 9.0 Login interface](https://opensource.hcltechsw.com/digital-experience/latest/extend_dx/portlets_development/mng_portlets_apps_widgets/modifying_portlet_app_and_portlets/portletapps_changelogin/?h=switching+hcl+digital+experience+9.5+practitioner+studio){target="_blank"}
