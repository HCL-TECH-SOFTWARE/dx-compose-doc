...
- **[Managing global settings](manage_global_settings.md)**
Learn how to configure global settings in DX Compose, including default language, unauthorized portlet visibility, landing pages, and search engine URLs.
