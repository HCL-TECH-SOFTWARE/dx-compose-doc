...
|-----|---------------|----------|
|[`incubator.configuration.digitalAssetManagement.enableRootCollectionSort`](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/manage_content/digital_assets/usage/managing_dam/upload_rich_media_assets/#sorting-root-and-nested-collections){target="_blank"}|<!--insert default value-->|CF237|
|[`incubator.configuration.digitalAssetManagement.enableSoftDelete`](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/manage_content/digital_assets/usage/managing_dam/dam_soft_delete/){target="_blank"}|<!--insert default value-->|CF237|
|[`incubator.configuration.digitalAssetManagement.renderNewUI`](https://pages.git.cwp.pnp-hcl.com/CWPdoc/dx-mkdocs/in-progress/manage_content/digital_assets/){target="_blank"}|<!--insert default value-->|CF237|
