...
|-----|---------------|----------|
|[`incubator.configuration.digitalAssetManagement.enableRootCollectionSort`](https://help.hcl-software.com/digital-experience/9.5/latest/manage_content/digital_assets/usage/managing_dam/upload_rich_media_assets/#sorting-root-and-nested-collections){target="_blank"}|<!--insert default value-->|CF237|
|[`incubator.configuration.digitalAssetManagement.enableSoftDelete`](https://help.hcl-software.com/digital-experience/9.5/latest/manage_content/digital_assets/usage/managing_dam/dam_soft_delete/){target="_blank"}|<!--insert default value-->|CF237|
|[`incubator.configuration.digitalAssetManagement.renderNewUI`](https://help.hcl-software.com/digital-experience/9.5/latest/manage_content/digital_assets/){target="_blank"}|<!--insert default value-->|CF237|
