...
DX Compose now supports Oracle as externalDB on Amazon RDS (19c and 21c). For more information, refer to [Configuring Oracle as an external database](../deploy_dx/manage/cfg_webengine/external_db_database_transfer.md){target="_blank"}.
