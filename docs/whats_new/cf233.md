...
The impersonation feature in HCL DX Compose no longer requires disabling the authentication cache. Starting with CF233, you can use the impersonation feature without any additional configuration. This allows administrators to act as a different user within the application for troubleshooting and verifying user-specific configurations while maintaining the performance benefits of authentication caching. For more information, refer to [Administering user impersonation](https://help.hcl-software.com/digital-experience/9.5/latest/deployment/manage/security/people/authorization/users_and_groups/impersonation/){target="_blank"}.