...
1.   [Language and region support in Portal Search](../search/language_region_support/index.md)  
...
1.  [Crawling web content with search seedlists](../search/crawling_webcontent_seedbase/index.md)  
...
1.  [Searching your local portal](../search/searching_local_portal/index.md)  
View information on setting up your local portal for your users to search.
1.  [Enabling anonymous users to search public pages of your portal](../search/enabling_anonymous_user/index.md)  
...
1.  [Redirecting search requests from a custom search form to the Search Center](redirect_search_custom_form.md)  
...
1.  [Remote search service](../search/remotesearch/index.md)  
