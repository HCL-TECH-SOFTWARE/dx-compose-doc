...
!!!note
     Do not set your JVM heap size larger than the allotted memory for the pod.  For more information, [JVM Heap and Pod Resource Guidelines](./index.md#jvm-heap-and-pod-resource-guidelines-performance-runs)