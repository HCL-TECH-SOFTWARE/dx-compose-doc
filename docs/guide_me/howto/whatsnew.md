...
| Type | Category | Article |
|------|----------|---------|
|New|Configuration|[How to set generic JVM arguments in the DX Compose WebEngine container](./configuration/settingGenericJVMArgs.md)|
...
|Referenced|Content|[How to get the UUID and Path of WCM content objects using a command line](https://help.hcl-software.com/digital-experience/9.5/latest/guide_me/howto/content/GetUUIDAndPathOfContent/){target="_blank"}|
|Referenced|Database|[How to determine portal database size when using DB2](https://help.hcl-software.com/digital-experience/9.5/latest/guide_me/howto/database/DB2DatabaseSize/){target="_blank"}|
